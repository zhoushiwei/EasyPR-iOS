...
namespace easypr {
    ...
    public:
        ...
        //! 旋转操作
        bool rotation(Mat& in, Mat& out, const cv::Size rect_size, const Point2f center, const double angle);
        ...
        //! 结果车牌显示
        Mat showResultMat(Mat src, cv::Size rect_size, Point2f center, int index);
